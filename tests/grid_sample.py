...
new_coords = (new_coords - 0.5) * 2 # map from [0, 1] to [-1, 1] and flip axes to match with grid_sample
...
gridsampled = F.grid_sample(z, new_coords, mode='bilinear', padding_mode="reflection", align_corners=False)
